...
class RouterController {
 public:
  ...
  void installSourceRoute(const unsigned char (&sourcRoute)[16], int port, uint32_t dst_addr, uint8_t tos, int);
...
public:
  ...
  vi Dijkstra(int);
  void makeSourceRoute(std::string,RouterController*, uint32_t, uint8_t);  
