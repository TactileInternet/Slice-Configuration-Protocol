...
class Switch7Topo(Topo):
	...
	self.addLink(switches[3], switches[5])
        ...
        t3 = self.addHost('t3', ip = "200.0.2.10/24", mac = 'ff:04:00:00:00:03')
        self.addLink(switches[1],t3)
        t4 = self.addHost('t4', ip = "200.0.3.10/24", mac = 'ff:04:00:00:00:04')
        self.addLink(switches[5],t4)
